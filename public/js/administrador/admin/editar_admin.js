...
const formEditar = document.querySelector("#formEditarAdmin");
...
// Funcion para obtener los datos de los administradores cuando se carga la página
document.addEventListener("DOMContentLoaded", async () => {
  console.log("DOM cargado");

  try {
    const response = await fetch(
      `http://localhost:3000/api/admin/${formEditar.dataset.id}`
    );
