...
router.get("/solicitar-turno", turnos.buscar_especialidades);
...
router.get(
  "/seleccionar/crear_turno/:doctor_fecha_horario_id",
  turnos.crear_turno
);
...
router.get(
  "/editar_devolucion_doctor/:devolucion_id",
  doctores.editar_devolucion_doctor
);
router.get(
  "/eliminar_devolucion_doctor/:devolucion_id",
  doctores.eliminar_devolucion_doctor
);
...
router.get(
  "/admin_eliminar_paciente/:eliminar_paciente",
  admin.eliminar_pacientes
);
router.get("/admin_editar_paciente/:editar_paciente", admin.editar_pacientes);
router.get("accion_modificar/:editar_paciente", admin.editar_pacientes);
...
router.get("/admin_agregar_doctor", admin.agregar_doctores);
router.post("/accion_crear_doctor", admin.crear_doctores);
router.get("/admin_editar_doctor/:editar_doctor", admin.editar_doctores);

//Manejando especialidades
router.get("/admin_especialidades", admin.admin_especialidades);
router.post("/admin_agregar_especialidad", admin.agregar_especialidad);
